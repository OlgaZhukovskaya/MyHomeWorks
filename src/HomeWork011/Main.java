...
public class Main {
    public static void main(String[] args) {
        ...
        long uniqueModelsCount = cars.stream()
                ...
                .distinct()
                .count();
        System.out.println("2. Уникальные автомобили: " + uniqueModelsCount + " шт.");

        // 3) Цвет автомобиля с минимальной стоимостью
        cars.stream()
                .min(Comparator.comparingInt(Car::getCost))
                .ifPresent(c -> System.out.println("3. Цвет автомобиля с минимальной стоимостью: " + c.getColor()));
        ...
        OptionalDouble avgCostToyota = cars.stream()
                ...
                .average();
        System.out.printf("4. Средняя стоимость модели %s: %.2f%n",
        ...
        OptionalDouble avgCostVolga = cars.stream()
                ...
                .mapToInt(Car::getCost)
                .average();
        System.out.printf("5. Средняя стоимость модели %s: %.2f%n",
